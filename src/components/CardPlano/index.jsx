...
export default function CardPlano({ index }) {
  return (
    <div className="flex flex-col p-10 rounded-lg shadow-lg w-11/12 min-h-fit  dark:bg-gray-800 dark:text-gray-50 border-gray-300/20 border-2 ring-1 ring-black/10
    ">
