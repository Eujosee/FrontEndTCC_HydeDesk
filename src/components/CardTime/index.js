    ...
    return(
        <div className="m-5 w-5/6 md:w-96  lg:m-auto lg:mb-10 flex flex-col justify-center bg-azul-hyde rounded-xl shadow-md ">
            <div className="flex py-10 justify-center items-center border-4 border-white rounded-full w-36 h-36 overflow-hidden m-auto my-10">
                <img className="object-cover" src={item.Foto} alt=""/>
            ...
            <div className="bg-white w-full rounded-t-3xl rounded-b-xl flex flex-col text-center justify-center items-center">
                <h1 className=" text-lg font-semibold m-4">{item.Nome}</h1>
                <p className="mb-4 w-2/3 text-center  text-gray-500"><span className="font-bold">Atuação: </span>{item.Atuacao}</p>
