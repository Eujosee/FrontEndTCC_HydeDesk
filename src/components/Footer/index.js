...
export default function Footer () {
        ...
        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
                ...
                <ul className="text-gray-600 dark:text-gray-400">
                    <li className="mb-4">
                        <Link to="/institucional" className="hover:underline">Quem somos</Link>
                        
                    </li>
                    <li>
                        <Link to="/institucional" className="hover:underline">Time</Link>
                    </li>
                </ul>
            </div>
            <div>
                ...
                <ul className="text-gray-600 dark:text-gray-400">
                    ...
                    <li>
                        <Link to="/" className="hover:underline">Benefícios</Link>
                    </li>
                </ul>
            </div>
            <div>
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <Link to="#" className="hover:underline">HydeDesk™</Link>. Todos os direitos reservados.
        </span>
        <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            <a href="https://www.instagram.com/hyde_desk/" target="_blank" rel="noreferrer" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
