      ...
      <nav className="flex max-w-full items-center justify-between p-6 lg:px-8" aria-label="Global">
                ...
                <Popover.Panel className="absolute -right-8 top-full z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl bg-white shadow-lg ring-1 ring-gray-900/5">
                    ...
                    <div
                        ...
                        <div className="flex-auto">
                            ...
                            <p className=" text-gray-600">Ver lista com todos os chamados</p>
                        </div>
                        </div>
                        {type === "funcionarios" &&
                        <div
                        ...
                        <div className="flex-auto">
                            ...
                            <p className=" text-gray-600">Abrir um novo chamado</p>
                        </div>
                        </div>
                        }
                    </div>
            ...
            >
                ...
                <div
                    ...
                    >
                        ...
                        <p className=" text-gray-600">Ver lista com todos os funcionários</p>
                        </div>
                    </div>
                    <div
                        className="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm leading-6 hover:bg-gray-50"
                    >
                        <div className="flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-gray-50 group-hover:bg-white">
                        <UserPlusIcon className="h-6 w-6 text-gray-600 group-hover:text-azul-hyde" aria-hidden="true" />
                        </div>
                        <div className="flex-auto">
                        <Link to="/cadastro-funcionario" className="block font-semibold text-gray-900">
                            Novo
                            <span className="absolute inset-0" />
                        </Link>
                        <p className=" text-gray-600">Cadastrar um novo funcionário</p>
                        </div>
                    </div>
                </div>
                </Popover.Panel>
        ...
        {authenticated ? 
            ...
            <Popover.Button className="group flex items-center gap-x-1 text-sm font-semibold leading-6 text-gray-900 ">
                <UserCircleIcon className="h-10 w-10 text-gray-900 group-hover:text-azul-hyde" aria-hidden="true" />
                <ChevronDownIcon className="h-5 w-5 flex-none text-gray-400 group-hover:text-azul-hyde" aria-hidden="true" />
            </Popover.Button>
            ...
            >
                ...
                <div
                    ...
                    >
                        <div className="flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-gray-50 group-hover:bg-white">
                        <UserCircleIcon className="h-6 w-6 text-gray-600 group-hover:text-azul-hyde" aria-hidden="true" />
                        </div>
                        <div className="flex-auto">
                        <Link to="/perfil" className="block font-semibold text-gray-900">
                            Meu Perfil
                            <span className="absolute inset-0" />
                        </Link>
                        <p className=" text-gray-600">Veja e edite suas informações</p>
                        </div>
                    </div>
                    <div
                        className="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm leading-6 hover:bg-gray-50"
                    >
                        <div className="flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-gray-50 group-hover:bg-white">
                        <ArrowRightOnRectangleIcon className="h-6 w-6 text-gray-600 group-hover:text-azul-hyde" aria-hidden="true" />
                        </div>
                        <div className="flex-auto">
                        <button onClick={() => handleLogout()} className="block font-semibold text-gray-900">
                            Deslogar
                            <span className="absolute inset-0" />
                        </button>
            ...
            <Link to="/login" className="bg-azul-hyde hover:bg-cyan-600 p-1 px-6 rounded-md text-white text-md font-semibold leading-6">
                Login 
            </Link>
            }
            </div>
