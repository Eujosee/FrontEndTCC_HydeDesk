      ...
      return (
        <div className="bg-white px-10 py-10 rounded-3xl">
          ...
          <div className="flex flex-col mb-10 justify-between">
            ...
            <p className="font-medium text-rg mb-0 ">{props.email}</p>
            </div>
          </div>
          ...
          <div className="text-black text-opacity-25 ">
            <p className="border-b-2"><strong>Endereço:</strong> {props.numero_endereco} </p>
            <p className="border-b-2"><strong>CEP:</strong> {props.cep} </p>
            <p className="border-b-2"><strong>CNPJ:</strong> {props.cnpj} </p>
            <p className="border-b-2"><strong>Telefone:</strong> {props.telefone} </p>
            <button
                className="hover:bg-cyan-600 mb-6 bg-azul-hyde p-2 rounded-3xl text-white font-bold text-lg"
                onClick={() => {
    ...
    case "funcionarios":
      return (
        <div className="bg-white px-10 py-10 rounded-3xl">
          ...
          <div className="text-black text-opacity-25">
            <p className="border-b-2"><strong>Nome:</strong> {props.nome} </p>
            <p className="border-b-2"><strong>Matrícula:</strong> {props.matricula} </p>
            <button
                className="hover:bg-cyan-600 mb-6 bg-azul-hyde p-2 rounded-3xl text-white font-bold text-lg"
                onClick={() => {
                  handleLogout()
