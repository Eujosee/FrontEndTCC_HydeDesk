...
export default function Detalhes() {
 ...
 return (
   <>
    <Header/>
    {!loading && <div className='flex flex-col w-full h-1/4 p-8'>
      <div className='mb-5'>
        ...
        <div className='w-1/2 flex flex-col space-y-4 data1'>
          <div className=' w-full flex space-x-2'> 
            <div className='flex flex-col w-1/2 '>
              ...
              <input type="text" className="bg-gray-300 rounded w-full h-10 pl-4 shadow" value={data[0].problema} disabled/>
            </div>
            <div className='flex flex-col w-1/2'>
              <label className='font-medium text-gray-500'>Setor:</label>
              <input type="text" className="bg-gray-300 rounded h-10 pl-4 shadow" value={data[0].setor} disabled/>
            </div>
          </div>

          <div className='flex flex-col w-full'>
              <label className='font-medium text-gray-500'>Patrimonio:</label>
              <input type="text" className="bg-gray-300 rounded h-10 pl-4 shadow" value={data[0].patrimonio } disabled/>
          </div>
          <div className='flex flex-col w-full'>
              <label className='font-medium text-gray-500'>Prioridade:</label>
              <input type="text" className="bg-gray-300 rounded h-10 pl-4 shadow" value={data[0].prioridade} disabled/>
          </div>
          <div className='flex flex-col w-full'>
              <label className='font-medium text-gray-500'>Descrição:</label>
              <textarea className="bg-gray-300 rounded h-36  pl-4 shadow" value={data[0].descricao} disabled/>
          </div>
        </div>
        <div className='w-1/2 data2'>
          <div className='flex w-full space-x-2'>
              <div className='flex flex-col text-center items-center justify-center w-1/2 pl-8'>
                    ...
                    <p className="text-lg font-bold rounded w-1/2">{data[0].cod_verificacao
}</p>
              </div>
