...
export default function Detalhes() {
 return (
		<>
			<Header />
			<div className="flex flex-col w-full p-8 dark:text-branco  dark:bg-preto h-screen">
				<div className="mb-5">
					...
					<div className="w-1/2 flex flex-col space-y-4 data1">
						<div className=" w-full flex space-x-2">
							<div className="flex flex-col w-1/2 ">
								...
								<input
									type="text"
									className="bg-gray-300 rounded w-full h-10 pl-4 shadow dark:text-branco  dark:bg-preto "
									value="Rede"
									disabled
								/>
							</div>
							<div className="flex flex-col w-1/2">
								...
								<input
									type="text"
									className="bg-gray-300 rounded h-10 pl-4 shadow dark:text-branco  dark:bg-preto"
									value="Rh"
									disabled
								/>
							</div>
						...
						<div className="flex flex-col w-full">
							...
							<textarea
								className="bg-gray-300 rounded h-36  pl-4 shadow dark:text-branco  dark:bg-preto"
								disabled
							/>
						</div>
					</div>
