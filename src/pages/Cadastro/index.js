    ...
    return (
        ...
        <div className="flex w-screen h-fit items-center  ">
            <div className="flex w-full items-center">
                    <div className="flex flex-col w-2/6 h-screen lg:flex bg-azul-claro-hyde justify-center items-center">
                            <Link to="/">
                            <h1 className="font-extrabold mr-2 text-3xl mb-12"><span className="font-extrabold text-white text-3xl">Hyde</span>Desk</h1>
                            </Link>
                ...
                <div className="flex flex-col w-full h-screen justify-center items-center overflow-y-auto">
                    <div className="lg:mt-10 px-10 flex flex-col w-full">
                        <div className="flex flex-row">
                            <h1 className="font-extrabold mr-2 text-3xl">Bem vindo a<span className="font-extrabold ml-1 text-azul-hyde text-3xl">Hyde</span>Desk</h1>
                        </div>
